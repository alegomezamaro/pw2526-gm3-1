...
```sql
-- Reset previous Student artifacts if present
DROP TABLE IF EXISTS `Student`;
...
('12345678A', 'Ana', 'López García',   'Av. del Puerto 12, Cádiz',   '1999-03-21', '2023-06-15', 1, NULL),
('87654321B', 'Javier',  'Martín Ruiz','C/ Cruz Conde 7, Córdoba',  '2001-11-02', '2024-01-10', 0, NULL),
('70890123C', 'Lucía',   'Serrano Torres', 'Gran Vía 101, Madrid',   '2000-08-14', '2022-09-01', 1, NULL),
('22446688D', 'Carlos',  'Castillo Romero','Rambla Catalunya 45, Barcelona', '1998-05-05', '2021-04-20', 0, NULL),
('33445566E', 'Beatriz', 'Navarro Fernández',  'C/ Larios 3, Málaga','2002-12-30', '2024-07-01', 0, NULL),
('44556677F', 'Sergio',  'Pérez Domínguez','Av. de la Constitución 8, Sevilla',  '1997-01-17', '2020-03-12', 1, NULL);
